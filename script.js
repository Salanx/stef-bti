const songs = [
    ...
    { title: "休止符", album: "未完成", year: 2003, vector: [-0.9, 0.4, -0.8, -0.6], lyrics: "感情的旅途，只是无意义的重复，让我写下爱的休止符。", desc: "你拥有极高的精神独立性，拒绝成为任何人的‘宠物’。当你感知到一段关系只是‘无意义的重复’时，你会优雅且果断地写下休止符，去征服更广阔的世界。" },
    ...
    { title: "180度", album: "是时候", year: 2011, vector: [0.5, 0.2, -1.0, -1.0], lyrics: "你的180度，是你转变的态度，我就让你一步。", desc: "在关系中，你拥有一种清醒的洒脱。面对对方180度的转变，你不会无谓地追赶当初，而是选择一个人住，把那份孤独化作不再让任何人背负的坦然。" },
     { title: "11", album: "是时候", year: 2011, vector: [-0.5, 1.0, 0.8, 0.7], lyrics: "善变不变，不停改变的蜕变，我拒绝再停歇不前，跟随慢拍的世界。", desc: "你拥有一种近乎本能的生命力，拒绝在平庸的慢拍世界里停滞不前。对你而言，生活是一场不停改变的蜕变。你在海市蜃楼般的意念中，依然执着地寻找着那个名为‘快乐’的原点。设定全新的焦点，去冲破束缚，创造属于你自己的乐园。" },
